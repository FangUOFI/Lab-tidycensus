...
```{r 3_FactFinder, echo=FALSE, fig.caption="Census Geographic Hierarchy", out.width = "500px"}
knitr::include_graphics("image/WB_3_Geogs.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("image/pop_2017.png")
```
